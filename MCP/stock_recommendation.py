...
from langgraph_supervisor import create_supervisor  # orchestrator
...
async def run_agent(query):
    ...
    news_analyst_agent = create_react_agent(model, tools, prompt="""You are a financial news analyst. Given the names or the tickers of Indian NSE listed stocks, your job is to-
