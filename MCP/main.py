...
from langchain_mcp_adapters.client import MultiServerMCPClient  # created by anthropic for multi agent servers
    ...
    client = MultiServerMCPClient(
        {
            "bright_data": {
                ...
                "args": ["@brightdata/mcp"],
                "env": {
                    "API_TOKEN": os.getenv("BRIGHT_DATA_API_TOKEN"), # used for web scraping/searching
